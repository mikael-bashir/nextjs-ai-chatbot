...
echo "        (Webhook signing secret is auto-generated by the Stripe CLI per deploy"
echo "         — no STRIPE_WEBHOOK_SECRET_TEST needed)"
echo "        (All other secrets are shared with production)"
echo ""
