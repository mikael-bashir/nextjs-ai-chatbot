...
echo "        STRIPE_SECRET_TEST             — Stripe test key  (sk_test_...)"
echo "        STRIPE_WEBHOOK_SECRET_TEST     — webhook signing secret for test endpoint"
echo "        (Everything else is shared with your production secrets)"
echo ""
